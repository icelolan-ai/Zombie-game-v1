...
for(const viewport of [{width:1280,height:800},{width:390,height:844},{width:844,height:390},{width:820,height:1180}]){
 ...
 report.push({viewport,errors,controls:boxes,drawCalls:await page.evaluate(()=>window.__game.view.renderer.info.render.calls)});assert.deepEqual(errors,[]);await context.close();
}
